...
# copy examples
cp -r /vagrant/quorum-secret-ballot /home/ubuntu/quorum-auction
chown -R ubuntu:ubuntu /home/ubuntu/quorum /home/ubuntu/quorum-auction

# done!
banner "Quorum"
echo
echo 'The Quorum vagrant instance has been provisioned. Code is available in ~/quorum-auction inside the instance.'
